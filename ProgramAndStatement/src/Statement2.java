...
public class Statement2 extends StatementSecondary {
    ...
    private void createNewRep() {
        ...
        this.rep = new Tree1<>();
        Sequence<Tree<StatementLabel>> statements = this.rep
                .newSequenceOfTree();
        StatementLabel label = new StatementLabel(Kind.BLOCK);
        this.rep.assemble(label, statements);
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        //make new sequence of trees of root's children
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        //disassemble the tree into the label and its sequence of children
        StatementLabel label = this.rep.disassemble(children);
        //we can directly access the position we want the new statement in
    ...
    public final int lengthOfBlock() {
        ...
        //put the tree into a sequence and return the length
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        StatementLabel label = this.rep.disassemble(children);
        //store the length since assemble clears the children sequence
    ...
    public final void assembleIfElse(Condition c, Statement s1, Statement s2) {
        ...
        //create local variables for the statements
        Statement2 localS1 = (Statement2) s1;
        Statement2 localS2 = (Statement2) s2;
        //create a new statement label for if else
        StatementLabel label = new StatementLabel(Kind.IF_ELSE, c);
        //new sequence for children
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        //add the statements to the children
    ...
    public final Condition disassembleIfElse(Statement s1, Statement s2) {
        ...
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        StatementLabel label = this.rep.disassemble(children);
        //remove the 0-th elements from the sequence
    ...
    public final void assembleWhile(Condition c, Statement s) {
        ...
        //create a new statement label for while
    ...
    public final void assembleCall(String inst) {
        ...
        //create new statement label with the string
