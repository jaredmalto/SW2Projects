...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //assign x to the data in the node
        newNode.data = x;

        /*
         * reassigning references within the list
         */
        //point first element in the right to the new node
        this.lastLeft.next.previous = newNode;
        //doubly link--point next in newNode to the first element in the right
        newNode.next = this.lastLeft.next;
        //point the lastLeft next at the new node
        this.lastLeft.next = newNode;
        //doubly link--point the previous in newNOde to the last element on the left
    ...
    public final T removeRightFront() {
        ...
        //create reference to right front node
        Node elem = this.lastLeft.next;
        //reference elem's data
        T elemData = elem.data;

        //the new right front element will be the next next element of the last left
        Node newRightFront = this.lastLeft.next.next;
        //point the new right front at lastleft
        newRightFront.previous = this.lastLeft;
        //doubly link--point lastleft.next at the new right front
    ...
    public final void advance() {
        ...
        //create a reference to the node we want to advance
        Node newLastLeft = this.lastLeft.next;
        //point lastleft at the new last left
    ...
    public final void moveToStart() {
        //assign lastLeft to move to front
        this.lastLeft = this.preStart;
    ...
    public final void moveToFinish() {
        ...
        //assign lastLeft to previous postFinish
    ...
    public final void retreat() {
        ...
        //assign lastLeft to the previous lastLeft
