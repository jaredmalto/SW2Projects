...
public abstract class ProgramTest {
    ...
    /**
     * Test of parse on syntactically valid input with more instructions.
     */
    @Test
    ...
    /**
     * Test of parse on syntactically invalid input with a primitive call as an
     * INSTRUCTION name.
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorPrimitiveAsInstructionName() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
    ...
    /**
     * Test of parse on syntactically invalid input with invalid body
     */
    @Test(expected = RuntimeException.class)
    public final void testParseErrorInvalidBody() {
        /*
         * Setup
         */
        Program pTest = this.constructorTest();
    ...
    /**
     * Test of parse on syntactically valid input with and empty body.
     */
    @Test
