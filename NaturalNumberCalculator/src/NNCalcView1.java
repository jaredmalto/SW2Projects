...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    private enum State {
        /**
         * Last event was clear, enter, another operator, or dπigit entry, resp.
         */
    ...
    public NNCalcView1() {
         ...
         */
        GridLayout mainButtonsLayout = new GridLayout(
                MAIN_BUTTON_PANEL_GRID_ROWS, MAIN_BUTTON_PANEL_GRID_COLUMNS);
        JPanel mainButtonsPanel = new JPanel(mainButtonsLayout);
        /*
         * Add the buttons to the main button panel, from left to right and top
         * to bottom
         */
        mainButtonsPanel.add(this.bDigits[SEVEN]);
        mainButtonsPanel.add(this.bDigits[EIGHT]);
        mainButtonsPanel.add(this.bDigits[NINE]);
        mainButtonsPanel.add(this.bAdd);
        mainButtonsPanel.add(this.bDigits[FOUR]);
        mainButtonsPanel.add(this.bDigits[FIVE]);
        mainButtonsPanel.add(this.bDigits[SIX]);
        mainButtonsPanel.add(this.bSubtract);
        mainButtonsPanel.add(this.bDigits[ONE]);
        mainButtonsPanel.add(this.bDigits[TWO]);
        mainButtonsPanel.add(this.bDigits[THREE]);
        mainButtonsPanel.add(this.bMultiply);
        mainButtonsPanel.add(this.bDigits[ZERO]);
        mainButtonsPanel.add(this.bPower);
        mainButtonsPanel.add(this.bRoot);
        mainButtonsPanel.add(this.bDivide);
        /*
         * Create side button panel
         */
        GridLayout sideButtonsLayout = new GridLayout(
                SIDE_BUTTON_PANEL_GRID_ROWS, SIDE_BUTTON_PANEL_GRID_COLUMNS);
        JPanel sideButtonsPanel = new JPanel(sideButtonsLayout);
        /*
         * Add the buttons to the side button panel, from left to right and top
         * to bottom
         */
        sideButtonsPanel.add(this.bClear);
        sideButtonsPanel.add(this.bSwap);
        sideButtonsPanel.add(this.bEnter);
        /*
         ...
         */
        combinedPanel.add(mainButtonsPanel);
        combinedPanel.add(sideButtonsPanel);
        /*
